...
func TestGetMapping(t *testing.T) {
	...
	assert.Equal(t, "text", mapping.Path("datum.properties.Whiskey.properties.value.type").Data().(string))
	assert.Equal(t, "text", mapping.Path("datum.properties.Whiskey.properties.schemaType.type").Data().(string))
}
